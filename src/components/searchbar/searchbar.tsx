...
function Searchbar() {
    ...
    return (
        <form action="/search" className="w-full text-[12px] gap-2 flex p-[4px] border border-gray-200 dark:border-slate-100/[0.09] rounded">
            <input className="px-2 bg-transparent flex-1 outline-none border-transparent focus:outline-purple/[0.1]" name="search" type="search" placeholder="Search for books, topics, snippets..." />
